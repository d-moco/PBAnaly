...
//	}
//
//	std::vector<int> PBBiologyAlg::biologyAPI::processArray(std::vector<int>& groupsX, int minDifference, int maxDifference)
//	{
...
//	vector<int> PBBiologyAlg::biologyAPI::get_bar_num(vector<unsigned char> buf)
//	{
//		vector<int> w;
...
//
//
//	std::vector<int> PBBiologyAlg::biologyAPI::checkArray(std::vector<int>& processX, Mat src, int start_y, int end_y, int meanW)
//	{
//		std::vector<int> result;
...
//	}
//
//	vector<std::array<int, 3>> PBBiologyAlg::biologyAPI::get_top_point(vector<unsigned char> rbuf, int range)
//	{
...
//	}
//
//	BandInfo PBBiologyAlg::biologyAPI::get_protein_lane_data(Mat src, Rect lane)
//	{
//		BandInfo band;
//		int sum = 0;
...
//
//
//	PBBiologyAlg::biologyAPI::biologyAPI() {}
//
//	PBBiologyAlg::biologyAPI::~biologyAPI() {}
//
//	std::vector<cv::Rect> PBBiologyAlg::biologyAPI::getProteinRect(Mat src)
//	{
//		cv::Mat edges;
...
//
//
//	std::vector<BandInfo> PBBiologyAlg::biologyAPI::getProteinBands(Mat src, std::vector<cv::Rect> lanes)
//	{
...
//
//
//	void PBBiologyAlg::biologyAPI::adjustBands(std::vector<BandInfo>& bands, int range)
//	{
//		// 用于存储所有的值及其对应的列索引
...
//	}
//
//	void PBBiologyAlg::biologyAPI::molecularWeightResult(std::vector<cv::Rect> lanes, std::vector<BandInfo>& bands)
//	{
//		for (int i = 0; i < bands.size(); i++)
//		{
